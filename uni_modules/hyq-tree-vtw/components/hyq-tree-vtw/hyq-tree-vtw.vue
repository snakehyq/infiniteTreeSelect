          ...
          <template v-if="isCheck">
            ...
            <template v-if="multiple">
              <view class="select-btn" @tap.stop="handleMulSelect(nodeItem)">
                <i
                  v-if="isMulSelect(nodeItem) == 1"
                  class="iconfont icon-xuanzhong txt icon-selected"
                />
                <i
                  v-else-if="isMulSelect(nodeItem) == 2"
...
<script>
// import search from "@/components/hyq-tree-vtw/search/search.vue";
// import treePopup from '@/components/hyq-tree-vtw/tree-Popup/tree-Popup.vue'
export default {
  name: "tree",
 //  components: {
 //    search,
  ...
  methods: {
    ...
    handleTreeChecked() {
      for (var i = 0; i < this.tree.length; i++) {
        ...
        const { treeNode = 0, treeNodeSelect = 0 } = this.handleCalcNodeAccount(
